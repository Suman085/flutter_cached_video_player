...
public class CachedVideoPlayerPlugin implements MethodCallHandler {
  ...
  private static class VideoPlayer {
    ...
    VideoPlayer(
      ...
      if (isFileOrAsset(uri)) {
        ...
        dataSourceFactory =
                new CacheDataSourceFactory(context, 1024*1024*1024, 1024*1024*100);
      }
  ...
  public static void registerWith(Registrar registrar) {
    ...
    final MethodChannel channel =
            new MethodChannel(registrar.messenger(), "flutter_cached_video_player");
  ...
  private CachedVideoPlayerPlugin(Registrar registrar) {
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    switch (call.method) {
      ...
      case "create":
      {
        ...
        EventChannel eventChannel =
                new EventChannel(
                        registrar.messenger(), "flutter_cached_video_player/videoEvents" + handle.id());
